...
const PrimerReact = props => (
  ...
  <Box align="center" px={4} className="container-lg">
    ...
    <FlexContainer width={1, 10/12} mx={'auto'} alignItems="center" className="flex-justify-center">
        <LinkLight fontSize={2} mr={4} mt={-2} href="https://primer.github.io/primer-react/">View component library</LinkLight>
        <Link href="https://codesandbox.io/s/1o7v0ryy3q?hidenavigation=1">
