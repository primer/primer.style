...
export default function AtomPlugins() {
  return (
    <Box px={4} mx={'auto'} className="container-xl">
      <Box my={[0, 3, 6]} mx={-4} className="d-flex flex-items-center flex-wrap flex-md-nowrap flex-md-row-reverse">
        ...
        <Box my={[4, 3, 0]} width={[1, 1, 6 / 12]} px={4}>
          ...
          <Text color="blue.2" is="p" fontSize={3} mb={4} pr={[0, 0, 0, 3]}>
            Install this custom Atom package to autocomplete classnames for Primer CSS and rails helpers for Octicons
          </Text>
          <ButtonFill mr={2} href="https://atom.io/packages/autocomplete-primer">
            Install package
          </ButtonFill>
