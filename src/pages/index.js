        ...
        <Box className="container-xl" px={2}>
          ...
          <Flex flexWrap="wrap" mr={[0, 0, -gutter]}>
            <Promo title="CSS framework" image={CSSImage} href="/css">
              Utility-centric and BEM-style components to give you the building
              blocks for any web project.
            </Promo>
            <Promo
              ...
              href="/components"
            >
              Presentational UI components with encapsulated styles and
              constraint-based theme props.
            </Promo>
            <Promo
              title="Octicons"
              image={OcticonsImage}
            ...
            >
              Your project. GitHub’s icons. Available in Ruby and JavaScript
              implementations.
            </Promo>
            <Promo
              title="Presentations"
              ...
              href="/presentations"
            >
              Slide templates that let you focus on the story without having to
              worry about the design details.
            </Promo>
            <Promo
              ...
              href="/design"
            >
              Principles, standards, and usage guidelines for designing GitHub
              interfaces.
            </Promo>
            <Promo
              title="Figma components"
              image={FigmaImage}
              href="/design/tools/figma"
            >
              Design layouts, flows, wireframes, and make prototypes with Primer
              components in Figma.
            </Promo>
          </Flex>
        </Box>
