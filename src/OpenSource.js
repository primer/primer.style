  ...
  <Box bg="blue.2" py={6} px={3} mt={6}>
    ...
    <Box color="black" className="container-xl p-responsive mx-auto">
      <Box mt={6} pt={4} borderTop={2} borderColor="black">
        <Text>Created and maintained by GitHub&#8217;s</Text> <LinkDark fontWeight="bold" href="https://github.com/orgs/primer/teams/ds-core/members">Design Systems team</LinkDark><Text>.</Text>
