...
const HiringPromo = props => (
  ...
  <Box align="center" px={4} className="container-lg text-left text-md-center">
    ...
    <Text is="p" fontSize={3} mb={4} px={[0, 0, 5]} color="orange.1">GitHub is looking for a Graphic Designer to join the Design Systems team. This role will tackle high-visibility design projects and build a library of design assets for use in presentations.</Text>
